...
class ChartAssignmentMLP(nn.Module):
    def __init__(self, input_dim=3, output_dim=8, hidden_dim=256, num_layers=8, degree=1):
        """
        ...
        self.degree = degree
        self.input_dim = input_dim * (2 * degree + 1)  # Adjust input_dim based on positional encoding
...
class TextureCoordinateMLP(nn.Module):
    def __init__(self, input_dim=3, output_dim=2, hidden_dim=256, num_layers=8, degree=4, n_charts=8):
        """
...
class SurfaceCoordinateMLP(nn.Module):
    def __init__(self, input_dim=2, output_dim=3, hidden_dim=256, num_layers=8, n_charts=8):
        """
